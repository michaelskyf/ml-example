...
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=os.path.join(LOGS_PATH, "inception_with_augments"))
...
model.save(os.path.join(MODELS_PATH, "inception3_with_augmentations.h5"))
